i2=imread('image2c.jpg'); % read the file
i2_1 = i2(1:600, 1:700, 1);
i2_2 = i2(1:600, 1:700, 2);
i2_3 = i2(1:600, 1:700, 3);
figure(3); 
imshow(i2); % display the image
h1 = [-3, -3, -3;
        -3, 24, -3;
        -3, -3, -3]; % impulse response (1‐by‐10, 1‐D filter)
...
figure(4); imshow(uint8(y1)); % map values into [0:255] before showing the figure 
